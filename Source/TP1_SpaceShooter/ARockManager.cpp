// cpp
	// Fichier: 'Source/TP1_SpaceShooter/ARockManager.cpp'
	...
	FVector AARockManager::GetRandomSpawnLocationOutside() const
	{
		...
		switch (Side)
		{
			case 0: X = FMath::FRandRange(LeftX, RightX); Y = TopY - OutsidePadding; break;
			case 1: X = RightX + OutsidePadding;          Y = FMath::FRandRange(TopY, BottomY); break;
			case 2: X = FMath::FRandRange(LeftX, RightX); Y = BottomY + OutsidePadding; break;
			default:X = LeftX - OutsidePadding;           Y = FMath::FRandRange(TopY, BottomY); break;
		}
	...
	void AARockManager::DestroyAllAsteroids()
	{
		for (int32 i = Asteroids.Num() - 1; i >= 0; --i)
		{
